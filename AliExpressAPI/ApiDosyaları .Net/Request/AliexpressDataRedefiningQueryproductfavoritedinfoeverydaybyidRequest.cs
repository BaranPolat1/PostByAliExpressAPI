...
{
    /// <summary>
    /// TOP API: aliexpress.data.redefining.queryproductfavoritedinfoeverydaybyid
    /// </summary>
    public class AliexpressDataRedefiningQueryproductfavoritedinfoeverydaybyidRequest : BaseTopRequest<Top.Api.Response.AliexpressDataRedefiningQueryproductfavoritedinfoeverydaybyidResponse>
    {
        /// <summary>
        /// 当前页码
        /// </summary>
