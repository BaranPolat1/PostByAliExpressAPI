...
{
    /// <summary>
    /// TOP API: cainiao.global.handover.commit
    /// </summary>
    public class CainiaoGlobalHandoverCommitRequest : BaseTopRequest<Top.Api.Response.CainiaoGlobalHandoverCommitResponse>
    {
        /// <summary>
