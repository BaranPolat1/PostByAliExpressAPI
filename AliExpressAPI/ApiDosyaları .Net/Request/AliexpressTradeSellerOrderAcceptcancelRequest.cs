...
{
    /// <summary>
    /// TOP API: aliexpress.trade.seller.order.acceptcancel
    /// </summary>
    public class AliexpressTradeSellerOrderAcceptcancelRequest : BaseTopRequest<Top.Api.Response.AliexpressTradeSellerOrderAcceptcancelResponse>
    {
        /// <summary>
        /// 入参如下
        /// </summary>
