...
{
    /// <summary>
    /// AliexpressOfferRedefiningFindbundlebyidResponse.
    /// </summary>
    public class AliexpressOfferRedefiningFindbundlebyidResponse : TopResponse
    {
        /// <summary>
        /// result
        /// </summary>
        [XmlElement("result")]
        public AeopOfferBundleFindResultDomain Result { get; set; }
...
public class AeopBundleSubItemDomain : TopObject
{
	...
	/// <summary>
/// AeopOfferBundleFindResultDomain Data Structure.
/// </summary>
[Serializable]

public class AeopOfferBundleFindResultDomain : TopObject
{
	        /// <summary>
	        /// 搭配ID
	        /// </summary>
